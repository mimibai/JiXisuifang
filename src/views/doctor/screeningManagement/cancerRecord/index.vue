...
export default {
  ...
  data() {
    return {
      cols: [
        ...
        { prop: 'code', label: '测评编号', width: '200px' },
        { prop: 'patientName', label: '患者姓名', width: '150px' },
        {
          prop: 'patientAge',
          label: '年龄',
          width: '75px',
        ...
        { prop: 'assessStateId', label: '测评状态', width: '150px' },
        // { prop: 'doctorName', label: '筛查医生', width: null },
        // { prop: 'pcClientName', label: '绑定终端', width: null },
        { prop: 'buttonList', label: '功能', width: '400px' }
      ],
      labelPosition: 'right',
      styleWidth: '160px',
      labelWidth: '150px',
  ...
  methods: {
    ...
    fetchData(params) {
      ...
      params = Object.assign(params || {}, { proTypeId: '2,3' })
    ...
    //   } else {
    //     this.minAge = value
    //     if (this.maxAge != null && value > this.maxAge) {
    ...
    //   } else {
    //     this.maxAge = value
    //     console.log((this.maxAge = value))
    //     if (this.minAge != null && this.minAge > value) {
